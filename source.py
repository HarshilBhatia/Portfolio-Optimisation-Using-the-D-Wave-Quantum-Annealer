...
# for i in range(2 * N):
#     bqm.add_variable(
#         "arr{}".format(i), -(1 - _lambda) * (returns[i / 2]) + P * (1 - 2 * A)
#     )

# for i in range(2 * N):
#     for j in range(i + 1, 2 * N):
#         bqm.add_interaction("arr{}".format(i), "arr{}".format(j), 2 * P)

# for i in range(N):
#     for j in range(N):
#         if i != j:
#             bqm.add_interaction(
#                 "arr{}".format(2 * i), "arr{}".format(2 * j), _lambda * sigma[i][j]
#             )
#             bqm.add_interaction(
#                 "arr{}".format(2 * i + 1),
#                 "arr{}".format(2 * j + 1),
...
#             )
#         else:
#             bqm.add_variable("arr{}".format(2 * i), _lambda * sigma[i][i])
#             bqm.add_variable("arr{}".format(2 * i + 1), _lambda * sigma[i][i])

#         bqm.add_interaction(
#             "arr{}".format(2 * i), "arr{}".format(2 * j + 1), _lambda * sigma[i][j]
#         )
